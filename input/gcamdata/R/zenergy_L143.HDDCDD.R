...
module_energy_L143.HDDCDD <- function(command, ...) {
  if(command == driver.DECLARE_INPUTS) {
    ...
    L143.HDDCDD_scen_R_Y %>%
      ...
      add_precursors("common/iso_GCAM_regID", "energy/GIS_ctry", "L101.Pop_thous_GCAM_IC_ctry_Y",
